...
--
-- Name: COLUMN repeater.fm_wakeup; Type: COMMENT; Schema: public; Owner: dz
--

COMMENT ON COLUMN public.repeater.fm_wakeup IS 'Tone or DTMF needed for activation of repeater, eg. "1750 Hz" or "DTMF 1"; Subtone is not relevant here';
...
--
-- Name: COLUMN repeater.locator; Type: COMMENT; Schema: public; Owner: dz
--

COMMENT ON COLUMN public.repeater.locator IS 'Maidenhead locator';
