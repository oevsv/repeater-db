...
# scraps Austrian DMR IPSC2 stations
...
def scrap_dmr_ipsc2():
    ...
    url = "https://ipsc2.oevsv.at/_status.html"
    headers = {
    ...
    try:
        with conn:
            with conn.cursor() as cur:
                ...
                print(f"Inserted {cur.rowcount} rows into scrap_dmr_ipsc2.")
